...
Mobile_graph1 = dcc.Graph(id='Mobile_graph1', style={'height': '100%', 'width' : '100%', 'maxWidth': '100%'}, config={'responsive': True})
Mobile_graph2 = dcc.Graph(id='Mobile_graph2', style={'height': '100%', 'width' : '100%', 'maxWidth': '100%'}, config={'responsive': True})
Mobile_graph3 = dcc.Graph(id='Mobile_graph3', style={'height': '100%', 'width' : '100%', 'maxWidth': '100%'}, config={'responsive': True})
...
graphs = html.Div([
    ...
    html.Div([
        ...
        html.Div([
            ...
            dcc.RadioItems(
                ...
                value='bubble', #this sets the default on startup
    ...
    html.Div([
        ...
        html.Div([
                html.Div(Mobile_graph2, style={'height': '100%'}),
                html.Div(Mobile_graph3, style={'height': '100%'})
