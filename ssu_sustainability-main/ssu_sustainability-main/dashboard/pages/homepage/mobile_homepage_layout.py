...
# layout imports
from pages.homepage.mobile_graphs_layout import graphs
from pages.homepage.filters import filters

register_page(__name__, path='/mobile_homepage', title="Energy Dashboard")
...
layout = html.Div([
    ...
    html.Div(filters, id='filters-sidebar', style={ #works now
        'flex-shrink' : '1', 
        'padding' : '10px', 
